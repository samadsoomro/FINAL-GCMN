        ...
        >
            ...
            <div className="bg-primary text-white pt-28 pb-20 relative overflow-hidden">
                ...
                <div className="container relative z-10 text-center">
                    ...
                    >
                        Stay informed about the latest events, announcements, and articles from Govt. College Formen Nazimabad
                    </motion.p>
                </div>
            </div>
                ...
                <div className="container">
                    {loading ? (
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[1, 2, 3].map((n) => (
                                <Card key={n} className="h-[400px] animate-pulse bg-slate-200/50 border-none rounded-2xl"></Card>
                            ))}
                        </div>
                    ) : posts.length === 0 ? (
                        <div className="text-center py-20">
                            <BookOpen className="mx-auto h-20 w-20 text-slate-300 mb-6" />
                            <h3 className="text-2xl font-bold text-slate-800">No posts yet</h3>
                            <p className="text-slate-500 mt-2">Check back soon for new updates!</p>
                        </div>
                    ) : (
                        <motion.div
                            variants={container}
                                        ...
                                        <Card className="h-full border-none shadow-sm hover:shadow-2xl transition-all duration-300 rounded-3xl overflow-hidden flex flex-col hover:-translate-y-2 bg-white ring-1 ring-slate-200/50">
                                            ...
                                            <div className="p-6 flex flex-col flex-1">
                                                ...
                                                <p className="text-slate-600 text-sm leading-relaxed mb-6 line-clamp-3">
                                                    {post.shortDescription || "Click to read more about this topic..."}
                                                </p>
